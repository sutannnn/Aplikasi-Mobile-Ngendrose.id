            ...
            content: Column(
              children: [
                  ...
                  child: ConstrainedBox(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        filled: true,
                        fillColor: Color.fromRGBO(161, 177, 194, 1),
                        hintText: "Link Website/Social Media/Marketplace",
                ...
                Padding(
                  ...
                  child: ConstrainedBox(
                    constraints:
                        BoxConstraints.tightFor(height: 100, width: 250),
                    child: TextFormField(
                        minLines: 2,
                        maxLines: 10,
  ...
  showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          title: Icon(Icons.mail_outline, size: 100, color: Colors.blue[800],),
          content: Container(
            height: 200,
